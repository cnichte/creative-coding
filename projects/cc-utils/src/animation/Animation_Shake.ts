 ...
 * File     : projects/cc-utils/animations/Shake.js
 * Version  : 1.0.0
...
Shake.provide_tweakpane_to = function (pane, folder, parameter_tweakpane, tweakpane_prefix = "") {
  ...
  folder.addInput(parameter_tweakpane, tweakpane_prefix + 'frequency', {
    label: 'Freqenz',
    min: 0.01,
    max: 2.0,
    step: 0.0001,
  ...
  folder.addInput(parameter_tweakpane, tweakpane_prefix + 'amplitude', {
    label: 'Amplitude',
    min: 0.01,
    max: 2.0,
    step: 0.0001
