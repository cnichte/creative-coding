 ...
 * File     : projects/cc-utils/animations/Rotate.js
 * Version  : 1.0.0
...
let AnimationTimeline = require('../AnimationTimeline.js');
let AnimationTimeline_Item = require('./AnimationTimeline_Item.js');

let Helper = require('../Helper.js');
let Mathematics = require('../Mathematics.js');
...
Rotate.TWEAKPANE_PREFIX = "_animation_rotate";
Rotate.Modes = {
  nothing: "nothing",
  weighing: 'weighing',
  rotate: "rotate"
...
Rotate.provide_tweakpane_to = function (pane, folder, parameter_tweakpane, tweakpane_prefix = "") {
  ...
  folder.addInput(parameter_tweakpane, tweakpane_prefix + 'boundary', {
    label: 'Boundary',
    min: -180,
    max: +180,
    step: 0.001,
  ...
  folder.addInput(parameter_tweakpane, tweakpane_prefix + 'increment', {
    label: 'Speed',
    min: 0.00,
    max: 200.00,
    step: 0.00001
